...
public class SpUtils {
    ...
    public void setSet(int resKey, Set<String> value) {
        setSet(this.context.getString(resKey), value);
    }
    ...
    public Set<String> getSet(int resKey, Set<String> defaultValue) {
        return getSet(this.context.getString(resKey), defaultValue);
    }
